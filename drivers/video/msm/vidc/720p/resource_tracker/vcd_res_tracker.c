...
/* 20110511 Y.Yagami ADD-S msm: vidc: Fix video core clock power up/down sequence */
...
bail_out:
	mutex_unlock(&resource_context.lock);
	return false;
/* 20110511 Y.Yagami ADD-E msm: vidc: Fix video core clock power up/down sequence */
}
